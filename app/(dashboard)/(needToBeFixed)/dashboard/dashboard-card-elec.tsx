...
export default function DashboardCard05() {
  ...
  const data = [
    50, 40, 60,  50, 40, 60,  50, 40, 60,  50, 40, 60,  50, 40, 60,  50, 40, 60,  50, 40, 60,  50, 40, 60,  50, 40, 60,  50, 40, 60,  50, 40, 60,  50, 40, 60,  50, 40, 60,  50, 40, 60, 
  ]
  ...
  return(
    <div className="flex flex-col col-span-full sm:col-span-6 dark:bg-gray-800 shadow-sm rounded-xl">
      <header className="px-5 py-4 border-b dark:border-gray-700/60 flex items-center">
        <h2 className="font-semibold text-gray-800 dark:text-gray-100">Electricity Consumption</h2>
      </header>
