...
export default function DashboardCard03() {
  ...
  return(
    <div className="flex flex-col col-span-full sm:col-span-6 xl:col-span-4 dark:bg-gray-800 shadow-sm rounded-xl">
      <div className="px-5 pt-5">
        <header className="flex justify-between items-start mb-2">
          <h2 className="text-lg font-semibold text-gray-800 dark:text-gray-100 mb-2">Cost</h2>
